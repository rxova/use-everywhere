...
- [#116](https://github.com/rxova/use-everywhere/pull/116) [`0ccf1ed`](https://github.com/rxova/use-everywhere/commit/0ccf1ed6e158c069792076d4134b087eaa8e114b) - `define-at-module-scope` and `no-dynamic-name` now match `createStoreHooks` as well as `defineStore`, so a codebase part-way through the 1.0 renames is checked either way. Rule ids and the recommended config are unchanged.
