...
| ------------------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------- |
| [`define-at-module-scope`](https://rxova.github.io/use-everywhere/eslint/define-at-module-scope/) | error       | `defineStore` / `defineChannel` / `createNamespace` inside a function |
| [`no-dynamic-name`](https://rxova.github.io/use-everywhere/eslint/no-dynamic-name/)               | error       | A bus name computed at runtime                                        |
| [`structured-clone-safe`](https://rxova.github.io/use-everywhere/eslint/structured-clone-safe/)   | error       | Functions, symbols and class instances in shared state                |
| [`leader-effect-captures`](https://rxova.github.io/use-everywhere/eslint/leader-effect-captures/) | warn        | A `useLeaderEffect` closing over a value that changes between renders |
